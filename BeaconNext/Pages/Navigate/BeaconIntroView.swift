    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("Keep your phone pointing straight forward. When using Explore, keep your phone upright, at chest level, and pointing straight ahead. Hold the bottom half of your phone so that you won't obstruct the camera.")
                ...
                Text("By continuing, you indicate your agreement to Orinav's Terms of Service and Privacy Policy. Your location may be shared internationally with third-party map providers to provide navigation services. See full terms for details.")
                Button("Open terms...") {
                ...
                Button("Agree and Continue") {
                    ...
                    globalState.locationProvider.requestPermissions() // The user has agreed to the privacy policy
                }
